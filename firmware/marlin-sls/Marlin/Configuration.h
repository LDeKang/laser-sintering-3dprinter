...
// :[0, 1, 2, 3, 4, 5, 6, 7, 8]
#define EXTRUDERS 1  // SLS: E轴用作铺料电机，非挤出机

// Generally expected filament diameter (1.75, 2.85, 3.0, ...). Used for Volumetric, Filament Width Sensor, etc.
#define DEFAULT_NOMINAL_FILAMENT_DIA 1.75

// For Cyclops or any "multi-extruder" that shares a single nozzle.
//#define SINGLENOZZLE  // SLS: 禁用单喷嘴模式
...
#define TEMP_SENSOR_BED 1  // SLS: 热床用于粉末预热（可选）
...
#define HEATER_0_MINTEMP   0  // SLS: 虚拟传感器，设为0
...
#define HEATER_0_MAXTEMP 300  // SLS: 提高上限避免虚拟传感器触发
 ...
 */
// SLS: E轴铺料加速度降低
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 200, 500 }
...
//
// SLS: 预加热配置改为粉末预热参数
#define PREHEAT_1_LABEL       "PA12"  // 尼龙12
#define PREHEAT_1_TEMP_HOTEND   0     // SLS: 无热端
#define PREHEAT_1_TEMP_BED    170     // 粉末预热温度
#define PREHEAT_1_TEMP_CHAMBER 80     // 成型室温度
#define PREHEAT_1_FAN_SPEED     0

#define PREHEAT_2_LABEL       "TPU"   // 弹性体
#define PREHEAT_2_TEMP_HOTEND   0     // SLS: 无热端
#define PREHEAT_2_TEMP_BED    160     // 粉末预热温度
#define PREHEAT_2_TEMP_CHAMBER 70     // 成型室温度
